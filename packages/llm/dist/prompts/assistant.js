// packages/llm/src/prompts/assistant.ts
var ASSISTANT_ROUTER_SYSTEM = `\u4F60\u662F Insight OS \u6D1E\u5BDF\u52A9\u624B\u7684"\u8DEF\u7531\u5C42"\u2014\u2014\u8D1F\u8D23\u628A\u7528\u6237\u7684\u81EA\u7136\u8BED\u8A00\u6D88\u606F\u89E3\u6790\u6210\u53EF\u6267\u884C\u7684\u7ED3\u6784\u5316\u6307\u4EE4\u3002
...
function buildAssistantRouterUserPrompt(input) {
  const histText = input.history.slice(-6).map((h) => {
...
var ASSISTANT_SUMMARIZER_SYSTEM = `\u4F60\u662F Insight OS \u6D1E\u5BDF\u52A9\u624B\u7684"\u5BF9\u8BDD\u5C42"\u2014\u2014\u628A\u68C0\u7D22/\u751F\u6210\u7684\u539F\u59CB\u7ED3\u679C\u7528\u81EA\u7136\u8BED\u8A00\u8BB2\u7ED9\u7528\u6237\u3002
...
- \u5076\u5C14\u7528 emoji\uFF08\u2728 / \u{1F4CC} / \u{1F4A1}\uFF09\u589E\u5F3A\u53EF\u8BFB\u6027\uFF0C\u4E0D\u8981\u6EE5\u7528
- \u5BA2\u6237\u6C9F\u901A\u8BED\u6C14\u8981"\u8F7B"\uFF0C\u4E0D\u8981\u5484\u5484\u903C\u4EBA
...
function buildAssistantSummarizerUserPrompt(input) {
  const dataStr = typeof input.data === "string" ? input.data : JSON.stringify(input.data, null, 2).slice(0, 3e3);
